        ...
        <div>
          ...
          <div className="mt-10 flex min-h-[56px] flex-wrap items-center gap-4">
            <button
              ...
              className="group inline-flex items-center gap-2 rounded-md bg-neutral-950 px-7 py-4 text-sm font-semibold text-white shadow-[0_8px_24px_rgba(15,23,42,0.18)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-neutral-800 active:scale-[0.98]"
            >
              추첨 참여하기
...
function PartnershipCTA() {
  ...
  return (
    <section className="bg-white py-24 text-center">
      ...
      <h2 className="text-4xl font-black tracking-tight text-neutral-950">공정한 래플 문화를 만들어갑니다</h2>
      ...
      <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
        <button
          onClick={() => go("/raffles")}
          className="inline-flex items-center gap-2 rounded-full bg-neutral-950 px-8 py-4 text-sm font-bold text-white transition hover:-translate-y-0.5 hover:bg-neutral-800"
        >
          추첨 참여하기 <Icon name="arrow" className="h-4 w-4" />
        </button>
        <button
          onClick={() => go("/partnership")}
          className="inline-flex items-center gap-2 rounded-full border border-neutral-200 px-8 py-4 text-sm font-bold text-neutral-900 transition hover:border-neutral-400 hover:bg-neutral-50"
        >
