...
// This raffleId must match the record in the backend DB / smart contract.
...
export function NikeRafflePage() {
  ...
  const handleParticipate = async () => {
    ...
    try {
      ...
      // mintRaffleTicket is onlyOwner — the backend owner key executes the
      // on-chain call. We pass the user's wallet as the recipient address.
      setPhase("minting");
      ...
      // POST /api/points/mint calls MintPoints on the Fabric chaincode,
      // crediting HYPERLEDGER_REWARD NOFAKE tokens to the user's ledger key.
      setPhase("rewarding");
        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <div className="relative aspect-square overflow-hidden rounded-3xl bg-gray-100">
            <img
              ...
              alt="Nike Air Max — Limited Edition"
          ...
          <div className="flex flex-col">
            ...
            <div className="mb-8 grid grid-cols-2 gap-4 rounded-2xl bg-gray-50 p-5">
              <div>
                ...
                <p className="text-sm font-bold text-gray-800">2026.05.06 ~ 2026.05.10</p>
              </div>
              <div>
                <p className="mb-1 text-xs font-semibold uppercase tracking-wider text-gray-400">
                  당첨 발표
                </p>
                <p className="text-sm font-bold text-gray-800">2026.05.12</p>
              </div>
              <div>
                <p className="mb-1 text-xs font-semibold uppercase tracking-wider text-gray-400">
                  참여 보상
